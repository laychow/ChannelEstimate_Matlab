...
f1=semilogy(snr,res_ul,'-^');

hold on;
f2=semilogy(snr,res_dl,'--^');
...
f3=semilogy(snr,res_ul,'-s');

hold on;
f4=semilogy(snr,res_dl,'--s');

grid on;
xlabel('SNR/dB');
ylabel('MSE');
legend([f1,f3],'without spatial rotation','with spatial rotation');