...
hold on;
h2=semilogy(snr,res_dl,'--o','Color',[56/255 145/255 204/255]);
...
hold on;
h4=semilogy(snr,res_dl,'--^','Color',[241/255 194/255 81/255]);
...
hold on;
h6=semilogy(snr,res_dl,'--s','Color',[145/255 188/255 87/255]);
